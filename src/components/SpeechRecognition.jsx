...
export const SpeechRecognition = () => {
  ...
  return (
    <div className='w-5/6 h-fit p-4 mt-4 bg-neutral-200 flex flex-col items-center rounded-lg gap-3'>
      ...
      {listening && (
        <button className='bg-sky-800 text-white w-full rounded-md p-2 flex justify-center items-center gap-2'>
      ...
      <div className=' w-full h-36 overflow-y-auto p-4 bg-neutral-100 rounded-lg border-neutral-300 border'></div>
